<template>
  <div class="header">
    ...
    <div class="hamburger hamburger--elastic">
      ...
      <div class="logo-block" v-if="$route.path !== '/ru/services'">
    ...
    <div class="burgerMenuLeft"
      ...
      <div @click.stop class="my-btn" style="display: flex; align-items: center"
        ...
        <div class="block-content"
          ...
          <btn
            @click="() => { $router.push('/ru'); blockBurgerMenu() }"
          ...
          >
            ...
            <transition name="list-animation">
              <div v-if="showList3"
                ...
                <btn
                  @click="() => { $router.push('/ru'); blockBurgerMenu(); blockShowList3()}"
                  :class="$route.path === '/ru' ? 'active-button' : 'buttons-header'"
                >
                  ГЛАВНАЯ
                </btn>
          ...
          <transition name="list-animation">
            <div v-if="showList2"
              ...
              <btn
                @click="() => { $router.push('/ru/projects'); blockBurgerMenu(); blockShowList()}"
                :class="$route.path === '/ru/achievements' ? 'active-button' : 'buttons-header'"
